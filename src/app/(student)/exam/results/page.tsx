      ...
      <div className="grid gap-5 lg:grid-cols-[.7fr_1.3fr]">
        <Card className="bg-exam text-white">
          <CardContent className="pt-6">
            <p className="text-sm text-white/70">MPK mock result</p>
            <p className="mt-3 text-6xl font-black">{score}%</p>
            <p className="mt-4 text-xs leading-5 text-white/60">
              Shortened independent simulation—not an official {exam} score,
              immigration result, or prediction. Writing and speaking receive
              completion credit here; their language quality is not
